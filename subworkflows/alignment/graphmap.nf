...
process getVersion {
    ...
    shell:
    """
    graphmap 2>&1| grep Versio| awk '{print "graphmap "\$2}'
    """
}
...
process map {
    ...
    """
        graphmap align -t ${task.cpus} ${params.EXTRAPARS} -r ${reference} -d ${fastq_file}  | samtools view -@ ${task.cpus} -F4 -hSb - > ${idfile}.bam
    """
}
