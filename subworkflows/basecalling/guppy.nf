...
process baseCallAndDemultiPlexNew {
    ...
    """
      ${library_export}
        guppy_basecaller ${gpu_cmd} \
        ${EXTRAPARS_BC} ${params.EXTRAPARS_DEM} -i ${infolder} \
        -s ./${idfile}_out \
        --gpu_runners_per_device 1 \
        --cpu_threads_per_caller 1 \
        --disable_qscore_filtering \
        ...
        --num_barcoding_threads ${task.cpus} 
 ...
 workflow BASECALL_DEMULTI {
    ...
    basecalling_stats = channel.value()
       ...
       switch(params.VERSION) {                      
           ...
           break;
           case "6.4":
 				baseCallAndDemultiPlexNew(input_fast5)
    			basecalled_fastq = baseCallAndDemultiPlexNew.out.basecalled_fastq
           break;           
    	}
